...
/* harmony export */   "createFirstLevel": () => (/* binding */ createFirstLevel),
/* harmony export */   "createGeneralDiv": () => (/* binding */ createGeneralDiv),
/* harmony export */   "createOneNewsEl": () => (/* binding */ createOneNewsEl),
/* harmony export */   "createPageContainer": () => (/* binding */ createPageContainer)
/* harmony export */ });
const body = document.body;

// Function for create general elements
function createGeneralDiv(tagHtml, className) {
...
function createFirstLevel(tagHtml, className, content) {
  const newElement = document.createElement(tagHtml);
  newElement.classList.add(className);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "setGenPageLayout": () => (/* binding */ setGenPageLayout)
/* harmony export */ });
/* harmony import */ var _createElement_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);


function setGenPageLayout() {
  (0,_createElement_js__WEBPACK_IMPORTED_MODULE_0__.createGeneralDiv)("div", "main-div"); //(tagHtml, className) creo il div principale non mi piace usare body

  (0,_createElement_js__WEBPACK_IMPORTED_MODULE_0__.createFirstLevel)("header", "header", ""); //(tagHtml, className, content) // creo Header

  (0,_createElement_js__WEBPACK_IMPORTED_MODULE_0__.createFirstLevel)("div", "core-div", " "); //(tagHtml, className, content) // creao il div centrale dove ci saranno
  ...
  (0,_createElement_js__WEBPACK_IMPORTED_MODULE_0__.createFirstLevel)("div", "btn-container", ""); //(tagHtml, className, content) // creo il bottone load-more

  (0,_createElement_js__WEBPACK_IMPORTED_MODULE_0__.createFirstLevel)(
    "footer",
    "footer",
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_main_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(11);
...
"use strict";
module.exports = __webpack_require__.p + "c590038a55de2222c2f7.png";
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _createElement_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _convertTime_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var _setGenPageLayout_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(17);
/* harmony import */ var _scss_main_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4);
...
function getOneNews(index) {
  return axios__WEBPACK_IMPORTED_MODULE_4__["default"].get(createUrl(index)); // promise da gestire o con "then" OPPURE con async function e await
}

function getData() {
  return axios__WEBPACK_IMPORTED_MODULE_4__["default"].get(API_500_NEWS); // promise da gestire o con "then" OPPURE con async function e await
}

async function getXnewsPerPage(array_id_news) {
  /////
  const PageEl = (0,_createElement_js__WEBPACK_IMPORTED_MODULE_0__.createPageContainer)(); // aggiungo il page-container per aggiungere tutte le nuove news in un unico blocco altrimenti apparivano una alla volta
  /////
  for (let i = actual_index; i < actual_index + news_per_page; i++) {
    ...
    let newsHumanTime = (0,_convertTime_js__WEBPACK_IMPORTED_MODULE_1__.convertTime)(newsEpochTime); // richiamo mia funzione esterna per convertire epoch time in human time
    (0,_createElement_js__WEBPACK_IMPORTED_MODULE_0__.createOneNewsEl)(newsTitle, newsLink, newsHumanTime, newsAuthor, PageEl); //(newsTitle, newsLink, newsHumanTime, newsAuthor)
  }
...
window.addEventListener("DOMContentLoaded", () => {
  (0,_setGenPageLayout_js__WEBPACK_IMPORTED_MODULE_2__.setGenPageLayout)();
  main_section();
});
